%% Tesla [20160225 20160811] datasets
...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Retreat\20160812\Tesla';
...
% TESLA DATASET STARTS
subject_ID{1}='Control';
group{1}                        = {'Tesla'};
dates_subject_in{1}                = {[20160225 20160811]};
...
group{2}                        = {'Tesla'};
dates_subject_in{2}                = {[20160225 20160811]};
