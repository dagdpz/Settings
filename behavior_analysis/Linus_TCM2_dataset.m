...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Linus_TCM2';
...
% LINUS TCM2 DATASET STARTS
subject_ID{1}='Control';
group{1}                        = {'Linus'};
dates_subject_in{1}                = {[20131017 20140526]};
...
group{2}                        = {'Linus'};
dates_subject_in{2}                = {[20131017 20140526]};
