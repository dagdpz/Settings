...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\2017\Linus_ina_controls';
...
group{2}                        = {'Flaffus'};
dates_subject_in{2}             = {[20170221 20170224]};
batching_type{2}                = 2; % 1 run by run, 2 session by session, 3 group by group
batching{2}.range_of_dates      = 1;
batching{2}.runs                = {};  % either empty or specific runs specified % either empty or specific runs specified
