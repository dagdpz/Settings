...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\2017\Linus_pulv_prr';
...
subject_ID{1}='Control';
group{1}                        = {'Linus'};
dates_subject_in{1}             = {20170608};
batching{1}.runs                = {3}; % 1 run by run, 2 session by session, 3 group by group
batching_type{1}                = 1;
...
group{2}                        = {'Linus'};
dates_subject_in{2}             = {20170608};
batching{2}.runs                = {5};  % either empty or specific runs specified % either empty or specific runs specified
