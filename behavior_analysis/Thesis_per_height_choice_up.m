...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\Pulv_eye_hand\behavior\2017\Revision_nov_2017\choices_mid';
...
switch GLO.eccentricity %%new
    case 'ALL'
        steady.tar_range_x                  =   [-100,100];
        steady.tar_range_y                  =   [-.1,.1];
    case 'CLOSE'
...
group{2}                        = {'Curius_phys'};
dates_subject_in{2}                = {[20150515 20150814]};
