...
GLO.one_subject                     =   0;
GLO.trial_by_trial                  =   1; % for statistics
GLO.CDF                             =   0;
GLO.text_in_plot                    =   1;
GLO.same_day                        =   0;
...
load('Y:\Projects\Pulv_eye_gaze_position\ephys\paper\behaviour_filelist.mat');

filelist_formatted=filelist_formatted.Lin_dPulv_Msac_mov;
...
% steady.saccade_definition           = 4;
% GLO.summary                         = [1,2];
% GLO.folder_to_save                  = 'Y:\Projects\Pulv_eye_gaze_position\behavior\Linus_corrective';
%keys.cal.MA_selection               ={'display',0,'summary',0,'keep_raw_data',1,'saccade_definition',4,'reach_1st_pos',1,'correlation_conditions',{},'nsacc_max', 20, 'sac_ini_t', 20,  'sac_end_t',  10, 'sac_min_dur', 0, 'sac_min_dur', 0, 'which_saccade', 'corrective'}; %!! this is most important difference

% run bh_summ_controls

steady.saccade_definition           = 4;
GLO.summary                         = [1,2];
GLO.folder_to_save                  = 'Y:\Projects\Pulv_eye_gaze_position\behavior\Linus_lat';
run bh_summ_controls

steady.saccade_definition           = 3;
GLO.summary                         = [1,2,3];
GLO.folder_to_save                  = 'Y:\Projects\Pulv_eye_gaze_position\behavior\Linus_acc';
run bh_summ_controls

%% -15
steady.fix_range_x                  =   [-20,-10];
steady.fix_range_y                  =   [-100,100];
steady.saccade_definition           = 4;
GLO.summary                         = [1,2];
GLO.folder_to_save                  = 'Y:\Projects\Pulv_eye_gaze_position\behavior\Linus_fix_1_lat';
run bh_summ_controls

steady.saccade_definition           = 3;
GLO.summary                         = [1,2,3];
GLO.folder_to_save                  = 'Y:\Projects\Pulv_eye_gaze_position\behavior\Linus_fix_1_acc';
run bh_summ_controls

%% 0
steady.fix_range_x                  =   [-10,10];
steady.fix_range_y                  =   [-100,100];
steady.saccade_definition           = 4;
GLO.summary                         = [1,2];
GLO.folder_to_save                  = 'Y:\Projects\Pulv_eye_gaze_position\behavior\Linus_fix_2_lat';
run bh_summ_controls

steady.saccade_definition           = 3;
GLO.summary                         = [1,2,3];
GLO.folder_to_save                  = 'Y:\Projects\Pulv_eye_gaze_position\behavior\Linus_fix_2_acc';
run bh_summ_controls

%% +15
steady.fix_range_x                  =   [10,20];
steady.fix_range_y                  =   [-100,100];
steady.saccade_definition           = 4;
GLO.summary                         = [1,2];
GLO.folder_to_save                  = 'Y:\Projects\Pulv_eye_gaze_position\behavior\Linus_fix_3_lat';
run bh_summ_controls

steady.saccade_definition           = 3;
GLO.summary                         = [1,2,3];
GLO.folder_to_save                  = 'Y:\Projects\Pulv_eye_gaze_position\behavior\Linus_fix_3_acc';
run bh_summ_controls
