...
keys.project_version='dPul_inj_LIP_Lin_6s_sig'; %Is this still used ?
...
keys.Linus.date                       ='[20210610 20211208]';
...
%  keys.pop(cc).tt.selection             	= {'in_AH_CS_Del_epoch_Dsac_han','en'};
%   keys.pop(cc).tt.selection             	= {'in_Cue_spaceLR_Dsac_han','CS'};
%   keys.pop(cc).tt.selection             	= {};
keys.pop(cc).tt.selection             	= {'in_CS_Cue_PTbl_Dsac_han','SU'};
...
% cc=cc+1;
% keys.sct(cc).X='in_IS_Cue_CT_epoch_DF_Dsac_han';
% keys.sct(cc).Y='in_IS_Cue_PT_epoch_DF_Dsac_han';
% keys.sct(cc).X_sig='in_IS_Cue_PTbl_Dsac_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='in_IS_Cue_PTbl_Dsac_han';
...
% cc=cc+1;
% keys.sct(cc).X='in_CS_Cue_CT_epoch_DF_Dsac_han';
% keys.sct(cc).Y='in_CS_Cue_PT_epoch_DF_Dsac_han';
% keys.sct(cc).X_sig='in_CS_Cue_PTbl_Dsac_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='in_CS_Cue_PTbl_Dsac_han';
% keys.sct(cc).tt.tasktypes={'Dsac_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
% keys.sct(cc).tt.hands=[0];
% keys.sct(cc).tt.choices=[0];
...
% cc=cc+1;
% keys.sct(cc).X='in_IS_Cue_CT_FR_Dsac_han';
% keys.sct(cc).Y='in_IS_Cue_PT_FR_Dsac_han';
% keys.sct(cc).X_sig='in_IS_Cue_PT_Dsac_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='in_IS_Cue_PT_Dsac_han';
% keys.sct(cc).tt.tasktypes={'Dsac_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
% keys.sct(cc).tt.hands=[0];
% keys.sct(cc).tt.choices=[0];
