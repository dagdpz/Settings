...
keys.position_and_plotting_arrangements             ={'eye_inactivation'};
...
keys.Linus.date                         ='[20171023 20171023]';
...
keys.tt.tasktypes                   ={'Ddsa_eye'}; % typically only one tasktype defines
keys.tt.hands                       =[1 2];
...
keys.pop(cc).tt.tasktypes               = {'Ddsa_eye'};
