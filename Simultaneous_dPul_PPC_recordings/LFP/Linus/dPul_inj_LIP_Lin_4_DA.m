...
lfp_tfa_cfg.version = 'dPul_inj_LIP_Lin_4_DA';
...
if ~lfp_tfa_cfg.process_LFP
    lfp_tfa_cfg.proc_lfp_folder = ...
        'Y:\Projects\Simultaneous_dPul_PPC_recordings\LFP\dPul_inj_LIP_Lin_4_DA\Processed LFP';
end
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        'Y:\Projects\Simultaneous_dPul_PPC_recordings\LFP\dPul_inj_LIP_Lin_4_DA\LFP Analysis';
end
...
%       be combined)
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20171023', ...
           'Input',         'Y:\Projects\PPC_pulv_eye_hand\ephys\LIP_dPul_inj_working_post_sfn_SF\sites_Linus_20171023.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', [2]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20171026', ...
           'Input',         'Y:\Projects\PPC_pulv_eye_hand\ephys\LIP_dPul_inj_working_post_sfn_SF\sites_Linus_20171026.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', [2]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20171102', ...
           'Input',         'Y:\Projects\PPC_pulv_eye_hand\ephys\LIP_dPul_inj_working_post_sfn_SF\sites_Linus_20171102.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', [2]);
    ...
    struct('Monkey',        'Lin', ...
           'Date',          '20171109', ...
           'Input',         'Y:\Projects\PPC_pulv_eye_hand\ephys\LIP_dPul_inj_working_post_sfn_SF\sites_Linus_20171109.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', [2]);
