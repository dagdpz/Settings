...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Controls_vs_MB\20160826';
...
subject_ID{1}='Control';
group{1}                        = {'C1_AUD'};
dates_subject_in{1}             = {[20160218 20160218]};
batching_type{1}                = 3; % 1 run by run, 2 session by session, 3 group by group
batching{1}.range_of_dates      = 0;
batching{1}.runs                = {7};  % either empty or specific runs specified in an array
