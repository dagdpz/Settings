...
GLO.paired_testing_when_possible    =   1;
...
if GLO.testing_patient
    steady.sac_ini_t                  = 80;
    steady.sac_end_t                  = 60;
    steady.sac_min_dur                      = 0;
    steady.eyetracker_sample_rate                  = 60; % Hertz
...
filelist=filelist_formatted;
% 
% GLO.folder_to_save                  =   'Y:\Projects\Pulv_oculomotor\behavior\Curius\Msac';
% filelist_formatted=filelist_formatted.Cur_dPulv_PT0_Msac_opt;
% filelist_formatted_Vsac=filelist_formatted.Cur_dPulv_PT0_Vsac_opt;
...
% end
% filelist_formatted=filelist_formatted_Msac;
% 
% % FLAFFUS EPHYS DATASET STARTS
% subject_ID{1}='Control';
% group{1}                        = repmat({'Curius_phys'},size(filelist_formatted,1),1);
...
% group{2}                        = repmat({'Curius_phys'},size(filelist_formatted,1),1);
...
% CURIUS MSAC
GLO.folder_to_save                  =   'Y:\Projects\Pulv_oculomotor\behavior\Curius\Msac';
filelist_formatted=filelist.Cur_dPulv_PT0_Msac_opt;
...
batching{2}.range_of_dates      = 0;
 ...
 run bh_summ_controls
 p_choice(1)=batch.stat.choice(1).saccades.lat.t_3_e_0_L_IN.raw_of_mean{4};
 p_choice(2)=batch.stat.choice(1).saccades.lat.t_3_e_0_R_IN.raw_of_mean{4};

% CURIUS VSAC
GLO.folder_to_save                  =   'Y:\Projects\Pulv_oculomotor\behavior\Curius\Vsac';
filelist_formatted=filelist.Cur_dPulv_PT0_Vsac_opt;
...
batching{2}.range_of_dates      = 0;
 ...
 run bh_summ_controls
 p_choice(3)=batch.stat.choice(1).saccades.lat.t_2_e_0_L_IN.raw_of_mean{4};
 p_choice(4)=batch.stat.choice(1).saccades.lat.t_2_e_0_R_IN.raw_of_mean{4};

% LINUS MSAC
GLO.folder_to_save                  =   'Y:\Projects\Pulv_oculomotor\behavior\Linus\Msac';
filelist_formatted=filelist.Lin_dPulv_PT0_Msac_opt;
...
batching{2}.range_of_dates      = 0;
 ...
 run bh_summ_controls
 p_choice(5)=batch.stat.choice(1).saccades.lat.t_3_e_0_L_IN.raw_of_mean{4};
 p_choice(6)=batch.stat.choice(1).saccades.lat.t_3_e_0_R_IN.raw_of_mean{4};

% LINUS VSAC
GLO.folder_to_save                  =   'Y:\Projects\Pulv_oculomotor\behavior\Linus\Vsac';
filelist_formatted=filelist.Lin_dPulv_PT0_Vsac_opt;
...
batching{2}.range_of_dates      = 0;
 ...
 run bh_summ_controls
 p_choice(7)=batch.stat.choice(1).saccades.lat.t_2_e_0_L_IN.raw_of_mean{4};
 p_choice(8)=batch.stat.choice(1).saccades.lat.t_2_e_0_R_IN.raw_of_mean{4};