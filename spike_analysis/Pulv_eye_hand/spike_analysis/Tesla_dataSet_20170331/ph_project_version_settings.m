...
keys.Tesla.date                         ='[20170331 20170331]';
keys.batching.targets                  = {'PUL_L'};
...
keys.WINDOWS_PER_TYPE{4}={...
    'Delay Period', 6,	-0.33,  1.35;... %1.35 1.15 1.1
...
keys.tt.selection                   ={'target','PUL_L'};                         % easy to use if there is a parameter in the tuning table for which you want your cells to have the same value
