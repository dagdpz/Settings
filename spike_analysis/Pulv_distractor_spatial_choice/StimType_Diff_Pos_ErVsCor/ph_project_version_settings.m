...
%keys.task_types             ={'mem'};
%keys.datasets               ={'Msac'};
keys.position_and_plotting_arrangements         ={'StimType_Diff_Pos_ErVsCor'};
...
keys.Bacchus.date                    ='[20210714 20210714]';
 keys.filelist_as_blocks     =1;
 keys.Bacchus.filelist_formatted          ={20210714,1};
%  onlz one Block
...
keys.EPOCHS_PER_TYPE{2}={...
    ...
    'Fhol',     4,	-0.25,	0,      'INI';...
    'Tacq',     4,	0.00,      0.15,   'INI';...
  %  'Cue',      4,	0.05,	0.15,   'INI';...
    'PreS',     60,	-0.1,	 -0.02,  'INI';...
    'PeriS',    60,	-0.02,	0.15,   'INI';...
    'PstS',     5,	0.0,	0.15,   'INI';...
    'Thol',     5,	0.2,	0.5,    'INI';...
    };
...
keys.ANOVAS_PER_TYPE(2).spaceLR            ={'PreS','PeriS','PstS','Tacq','Thol'}';
keys.ANOVAS_PER_TYPE(2).positions          ={'PreS','PeriS','PstS','Tacq','Thol'}';
keys.ANOVAS_PER_TYPE(2).hands              ={'Fhol','PreS','PeriS','PstS','Tacq','Thol'}';
keys.ANOVAS_PER_TYPE(2).SxH                ={'PreS','PeriS','PstS','Tacq','Thol'}';
keys.ANOVAS_PER_TYPE(2).main               ={'Fhol','PreS','PeriS','PstS','Tacq','Thol'}';
