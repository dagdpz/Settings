...
%keys.task_types             ={'mem'};
%keys.datasets               ={'Msac'};
keys.position_and_plotting_arrangements         ={'DpT_Diff_DisTar', 'DpS_Diff_DisTar'}; %, 'Sgl_Diff_Pos_Suc_SaccadeEpoch'

keys.condition_parameters  ={'stimulustype', 'success'}; %
%keys.plot.vertical_positons_PSTH        =1;%keys.plot.average_heat_maps             =1;
...
keys.cal.units_from_sorting_table       =1;keys.cal.MA_selection                   ={'display',0,'keep_raw_data',1,'saccade_definition',4,'reach_1st_pos',1,'success',1,'stimuli_in_2hemifields', 1, 'n_nondistractors',1, 'correlation_conditions',{}};    
...
keys.pop(cc).tt.unselect                ={'ch_Tacq_spaceLR_Vsac_SpS', '-' }; 
...
keys.pop(cc).group_parameter            = 'ch_Tacq_spaceLR_Vsac_SpS'; % ch_Tacq_spaceLR_Vsac_Stigrouping units - hand_tuning from the Tuning-table
