...
keys.project_version='MIP_dPul_inj_w_o_20171012';
...
keys.ANOVAS_PER_TYPE(4).spaceLR            ={'INI','Facq','Fhol','Cue','EDel','Del','PreR','PeriR','PostR','Thol'}';
keys.ANOVAS_PER_TYPE(4).positions          ={'Facq','Fhol','Cue','EDel','Del','PreR','PeriR','PostR','Thol'}';
keys.ANOVAS_PER_TYPE(4).hands              ={'INI','Facq','Fhol','Cue','EDel','Del','PreR','PeriR','PostR','Thol'}';
keys.ANOVAS_PER_TYPE(4).SxH                ={'INI','Facq','Fhol','Cue','EDel','Del','PreR','PeriR','PostR','Thol'}';
keys.ANOVAS_PER_TYPE(4).main               ={'INI','Facq','Fhol','Cue','EDel','Del','PreR','PeriR','PostR','Thol'}';
...
% try here to plot inst vs choice  
...
% cc=cc+1;
% keys.sct(cc).X='in_IH_IS_Del_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_IH_IS_Del_CT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_IH_IS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_IH_IS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
% keys.sct(cc).tt.hands=[1 2];
% keys.sct(cc).tt.choices=[0 1];
% keys.sct(cc).tt.perturbations               = [0 1];
% 
% cc=cc+1;
% keys.sct(cc).X='in_IH_CS_Del_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_IH_CS_Del_CT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_IH_CS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_IH_CS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
% keys.sct(cc).tt.hands=[1 2];
% keys.sct(cc).tt.choices=[0 1];
...
% cc=cc+1;
% keys.sct(cc).X='in_CH_CS_Del_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_CH_CS_Del_CT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_CH_CS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_CH_CS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
% keys.sct(cc).tt.hands=[1 2];
% keys.sct(cc).tt.choices=[0 1];
...
% cc=cc+1;
% keys.sct(cc).X='in_CH_IS_Del_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_CH_IS_Del_CT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_CH_IS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_CH_IS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
% keys.sct(cc).tt.hands=[1 2];
% keys.sct(cc).tt.choices=[0 1];
...
% 
% cc=cc+1;
% keys.sct(cc).X='in_IH_IS_Del_PT_FR_Ddre_han';
% keys.sct(cc).Y='ch_IH_IS_Del_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_IH_IS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_IH_IS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
...
% 
% cc=cc+1;
% keys.sct(cc).X='in_IH_CS_Del_PT_FR_Ddre_han';
% keys.sct(cc).Y='ch_IH_CS_Del_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_IH_CS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_IH_CS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
...
% 
% cc=cc+1;
% keys.sct(cc).X='in_CH_CS_Del_PT_FR_Ddre_han';
% keys.sct(cc).Y='ch_CH_CS_Del_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_CH_CS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_CH_CS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
...
% 
% cc=cc+1;
% keys.sct(cc).X='in_CH_IS_Del_PT_FR_Ddre_han';
% keys.sct(cc).Y='ch_CH_IS_Del_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_CH_IS_Del_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_CH_IS_Del_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
...
% cc=cc+1;
% keys.sct(cc).X='in_IH_IS_PreR_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_IH_IS_PreR_CT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_IH_IS_PreR_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_IH_IS_PreR_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
% keys.sct(cc).tt.hands=[1 2];
% keys.sct(cc).tt.choices=[0 1];
...
% cc=cc+1;
% keys.sct(cc).X='in_IH_CS_PreR_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_IH_CS_PreR_CT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_IH_CS_PreR_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_IH_CS_PreR_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
% keys.sct(cc).tt.hands=[1 2];
% keys.sct(cc).tt.choices=[0 1];
...
% cc=cc+1;
% keys.sct(cc).X='in_CH_CS_PreR_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_CH_CS_PreR_CT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_CH_CS_PreR_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_CH_CS_PreR_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
% keys.sct(cc).tt.hands=[1 2];
% keys.sct(cc).tt.choices=[0 1];
...
% cc=cc+1;
% keys.sct(cc).X='in_CH_IS_PreR_CT_FR_Ddre_han';
% keys.sct(cc).Y='ch_CH_IS_PreR_CT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_CH_IS_PreR_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_CH_IS_PreR_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
% keys.sct(cc).tt.hands=[1 2];
% keys.sct(cc).tt.choices=[0 1];
...
% 
% cc=cc+1;
% keys.sct(cc).X='in_IH_IS_PreR_PT_FR_Ddre_han';
% keys.sct(cc).Y='ch_IH_IS_PreR_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_IH_IS_PreR_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_IH_IS_PreR_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
...
% 
% cc=cc+1;
% keys.sct(cc).X='in_IH_CS_PreR_PT_FR_Ddre_han';
% keys.sct(cc).Y='ch_IH_CS_PreR_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_IH_CS_PreR_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_IH_CS_PreR_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
...
% 
% cc=cc+1;
% keys.sct(cc).X='in_CH_CS_PreR_PT_FR_Ddre_han';
% keys.sct(cc).Y='ch_CH_CS_PreR_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_CH_CS_PreR_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_CH_CS_PreR_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
...
% 
% cc=cc+1;
% keys.sct(cc).X='in_CH_IS_PreR_PT_FR_Ddre_han';
% keys.sct(cc).Y='ch_CH_IS_PreR_PT_FR_Ddre_han';
% keys.sct(cc).X_sig='in_CH_IS_PreR_PT_Ddre_han'; % O > ^ o (filled) 
% keys.sct(cc).Y_sig='ch_CH_IS_PreR_PT_Ddre_han';
% keys.sct(cc).tt.tasktypes={'Ddre_han'};
% keys.sct(cc).tt.IC_for_criterion='in';
