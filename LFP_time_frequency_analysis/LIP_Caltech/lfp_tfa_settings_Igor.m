...
lfp_tfa_cfg.results_folder = [base_drive filesep 'Projects\LIP_Caltech\converted'];
...
if ~lfp_tfa_cfg.process_LFP
    lfp_tfa_cfg.proc_lfp_folder = ...
        [base_drive filesep 'Projects\LIP_Caltech\converted\LFP'];
end
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        [base_drive filesep 'Projects\LIP_Caltech\converted\LFP\LFP Analysis'];
end
...
data_folder = 'E:\Projects\LIP_Caltech\converted';
cd(data_folder)
sess_files = dir('*.mat');
