...
lfp_tfa_cfg.version = 'Interleaved';
lfp_tfa_cfg.contra_ipsi_relative_to='target'; %% or 'perturbation_site'
...
if ~lfp_tfa_cfg.process_LFP
    lfp_tfa_cfg.proc_lfp_folder = ...
        'Y:\Projects\Pulv_eye_hand\LFP\Interleaved\Processed LFP';
end
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        'Y:\Projects\Pulv_eye_hand\LFP\Interleaved\LFP Analysis';
end
...
lfp_tfa_cfg.info_filepath = 'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\Fla_sorted_neurons.xls';
lfp_tfa_cfg.info_filepath = 'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\Lin_sorted_neurons.xls';
%%
...
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Lin', ...
           'Date',          '20160513', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Linus_20160513.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Lin', ...
           'Date',          '20160518', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Linus_20160518.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Lin', ...
           'Date',          '20160520', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Linus_20160520.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Lin', ...
           'Date',          '20160526', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Linus_20160526.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Lin', ...
           'Date',          '20160527', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Linus_20160527.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Fla', ...
           'Date',          '20160603', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Flaffus_20160603.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Fla', ...
           'Date',          '20160608', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Flaffus_20160608.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Fla', ...
           'Date',          '20160609', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Flaffus_20160609.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Fla', ...
           'Date',          '20160616', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Flaffus_20160616.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Fla', ...
           'Date',          '20160617', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Flaffus_20160617.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
...
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Fla', ...
           'Date',          '20160629', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Flaffus_20160629.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Fla', ...
           'Date',          '20160630', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Flaffus_20160630.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Fla', ...
           'Date',          '20160721', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Flaffus_20160721.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);
sess=sess+1;
lfp_tfa_cfg.session_info(sess) = ...
    struct('Monkey',        'Fla', ...
           'Date',          '20160722', ...
           'Input',         'Y:\Projects\Pulv_eye_hand\ephys\Interleaved\sites_Flaffus_20160722.mat', ...
           'Preinj_blocks',  0, ...
           'Postinj_blocks', []);       
...
lfp_tfa_cfg.compare.targets = {'dPulv'}; 
...
%%
lfp_tfa_cfg.plot_site_average = 1;
...
lfp_tfa_cfg.analyse_epochs = {lfp_tfa_states.FIX_ACQ,     'INI',    -0.4 ,    -0.1  ;...
                              lfp_tfa_states.CUE_ON,     'Fhol',    -0.3 ,    0  ;...
                              lfp_tfa_states.CUE_ON,     'Cue' ,    0.06 ,    0.12 ; ...
                              lfp_tfa_states.TAR_ACQ,    'EDel',    -1 ,     -0.7 ; ...
                              lfp_tfa_states.TAR_ACQ,    'Del',     -0.3 ,    0  ; ...
                              lfp_tfa_states.SAC_INI,    'PreS',    -0.3 ,    -0.05 ; ...
                              lfp_tfa_states.SAC_END,    'PeriS',   -0.02 ,    0.08 ; ...
                              lfp_tfa_states.REA_INI,    'PreR',    -0.4 ,    -0.1 ; ...
                              lfp_tfa_states.REA_END,    'PeriR',   -0.05 ,    0.25 ; ...
...
lfp_tfa_cfg.compare.effectors = [3,4,6];
...
lfp_tfa_cfg.diff_condition(3)={{'type_eff',{[4 3],[4 4]}}};
lfp_tfa_cfg.diff_condition(4)={{'type_eff',{[4 3],[4 6]}}};
lfp_tfa_cfg.diff_condition(5)={{'type_eff',{[4 4],[4 6]}}};
% 
