...
lfp_tfa_cfg.results_folder = 'Y:\Projects\Pulv_distractor_spatial_choice\LFP';
...
if ~lfp_tfa_cfg.process_LFP
    lfp_tfa_cfg.proc_lfp_folder = ...
        ['Y:\Projects\Pulv_distractor_spatial_choice\LFP\' version '\Processed LFP'];
end
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        ['Y:\Projects\Pulv_distractor_spatial_choice\LFP\' version '\LFP Analysis'];
end
...
mainfolder=['Y:\Projects\Pulv_distractor_spatial_choice\ephys\ECG_taskRest\'];
...
lfp_tfa_cfg.compare.targets = {'dPul'}; 
...
lfp_tfa_cfg.analyse_states = {'single', lfp_tfa_states.TAR_ACQ,   'Cue on',    -0.5,   0.5;...
                              'single', lfp_tfa_states.SAC_INI,   'Sac ini',      -0.5,   0.5; ...
                              'single', lfp_tfa_states.REWARD,    'Reward',      -0.5,   0.5};
...
lfp_tfa_cfg.analyse_epochs = {lfp_tfa_states.TAR_ACQ,         'Cue on' ,    0.07,   0.17 ; ...
                              lfp_tfa_states.SAC_INI,        'Sac ini',    -0.1, 	-0.01; ...
                              lfp_tfa_states.REWARD,        'Reward',    0.2,    0.5   };
