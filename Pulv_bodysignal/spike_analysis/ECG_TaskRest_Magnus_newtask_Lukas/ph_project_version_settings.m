...
keys.Magnus.date                    ='[20230601 20230801]'; % 20220921  20221206 20221222 20230104
...
keys.batching.targets               ={'dPul'}; % ,'VPL' % no vpl here, yet (?)
...
keys.ons(cc).tt.tasktypes               = {'Vsac_opt'};keys.pop(cc).epoch_BL                   = 'none';               % Epoch to subtract trial by trial (if FR_subtract_baseline ~ 0)
...
keys.ons(cc).comparisons_per_effector(ce).title='Aligned to target onset';
ce=ce+1;
