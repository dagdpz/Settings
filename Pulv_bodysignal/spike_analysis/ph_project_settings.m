...
keys.ANOVAS_PER_TYPE(2).spaceLR            ={'Fhol','Tacq'}';
keys.ANOVAS_PER_TYPE(2).positions          ={'Fhol','Tacq'}';
keys.ANOVAS_PER_TYPE(2).hands              ={'Fhol','Tacq'}';
keys.ANOVAS_PER_TYPE(2).SxH                ={'Fhol','Tacq'}';
keys.ANOVAS_PER_TYPE(2).main               ={'Fhol','Tacq'}';
