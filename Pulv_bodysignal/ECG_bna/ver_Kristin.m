...
ecg_bna_cfg.LFP_version='ver_Kristin';
ecg_bna_cfg.spikes_version='ECG_TaskRest_Kristin';
...
sessions{1}=sort([20220211, 20220221, 20220222, 20220224, 20220225, 20220309, 20220310, 20220315, 20220318 ]); % next 20211001, 20211207, 20211208
