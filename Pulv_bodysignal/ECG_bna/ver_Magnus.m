...
ecg_bna_cfg.LFP_version='ver_Magnus';
ecg_bna_cfg.spikes_version='ECG_TaskRest_Magnus_MayJune';
...
sessions{1}=sort([20230518,20230524,20230525,20230526]); % add 20230531 later
% sessions{1}=sort([20230112]); 
% 20220921 *task only, 20221115,20221118,20221122,20221125,
% 20221130 *no ecg/cap,20221206,20221222,20221229,20230104,
% 20230106 *VPL+dPul,20230112 *VPL+dPul, 20230126 *VPL + dPul,
% 20230511 *VPL+dPul, 20230518 *dPul+AIP,20230519 *dPul(+) + dPul(broken),
% 20230524 *AIP+dPul,20230525 *dPul + dPul,20230526 *dPul+dPul,
% 20230531 *PCC+AIP,20230601 *dPul+dPul,20230602 *dPul+dPul,
% 20230607 *dPul 32ch,20230608 *PCC+AIP,20230609 *PCC+dPul,
% 20230614 *MD+dPul, 20230615 *MD+dPul, 20230616 *MD+dPul,
% 20230621 *MD+dPul,20230622 *MD+dPul,20230623 *MD+PPC %
...
ecg_bna_cfg.analyse_states = {'ecg', 'R peak', -0.5, 0.5};
