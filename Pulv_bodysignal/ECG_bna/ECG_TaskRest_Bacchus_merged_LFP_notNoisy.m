...
sessions{1} = unique([...
    20210715, 20210716, 20210720 , 20210722, 20210723, 20210729,...
    20210730, 20210805, 20210806,20210826,20210827,20210903,...
    20210905, 20210906, 20210930,20211001,20211005,20211007,...
    20211012, 20211013, 20211014,20211019,20211027,20211028,...
    20211102, 20211103, 20211116,20211117,20211207,20211214,...
    20211222, 20220105, 20220106,20220203,20220211,20220221,...
    20220222, 20220224, 20220225,20220309,20220310,20220315,...
    20220318, 20220322]);
%%
%these are the ones we want to rerun
...
cfg.targets = {'dPul_R', 'dPul_L','VPL_R', 'VPL_L','mdT_L','mdT_R','AIP_R','AIP_L','PCC_L','PCC_R', 'PPC_L', 'PPC_R'};
