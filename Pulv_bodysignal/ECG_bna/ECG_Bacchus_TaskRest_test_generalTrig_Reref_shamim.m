...
monkeys={'Bacchus'};
% Done; 20210715, 20210716,20210720, 20210722, 20210723, 20210729, 20210730, 20210805, 20210826, 20210827, ...
% 20210905, 20210906, 20210930, 20211007, 20211012, 20211013, 20211014, 20211019, 20211028, 20211103, 20211116, ...
...
% Error:  20210806 , 20210903, 20211027, 20211102, 
sessions{1}=sort(unique([20210715, 20210716,20210720, 20210722, 20210723, 20210729, ...
    20210730, 20210805, 20210826, 20210827, 20210905, 20210906, ...
    20210930, 20211007, 20211012, 20211013, 20211014, 20211019, ...
    20211028, 20211103, 20211116, 20211117, 20211207, 20211214, ...
    20220105, 20220106, 20220203, 20220211, 20220221, 20220222, ...
    20220224, 20220225, 20220309, 20220310, 20220315, 20220318, 20220322  ])); % skipped ,20211001,20211005,20211222
...
cfg.analyse_states = {'R',    'Rpeak',1,-0.25, 0.25;...
    'R_low', 'Rpeak_lowIBI',1,-0.25, 0.25;...
    'R_high', 'Rpeak_highIBI',1,-0.25, 0.25;...
    }; % 'Cue',  'state',4,-0.10, 0.4 ==> this was done from 20210805 until end
