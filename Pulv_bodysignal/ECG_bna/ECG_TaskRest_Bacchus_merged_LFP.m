...
ecg_bna_cfg.LFP_version='ECG_TaskRest_Bacchus_merged_LFP';%% this is for saving (everything?)
ecg_bna_cfg.spikes_version='ECG_TaskRest_Bacchus_merged'; %% this is for loading tuning table (?)
...
ecg_bna_cfg.version = version; %'Bacchus_Reach_InakdPul_ECG';
...
monkeys={'Bacchus'};
sessions{1}=unique([20211019 20211027 20211028 20211102 20211103 20211116 20211117 20211207]);
% sessions{1}=unique([...
