...
cfg.outNameCap = 0;
cfg.spikes_version='ECG_TaskRest_Bacchus_merged_state4'; %% this is for loading tuning table (?)
...
%cfg.analyse_states = { {'ecg', 'R peak', -0.25, 0.25, 10, 10}};%, ...
