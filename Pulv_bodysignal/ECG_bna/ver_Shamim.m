...
ecg_bna_cfg = [];
ecg_bna_cfg.outNameCap = 1; %it's out for CAP data
ecg_bna_cfg.LFP_version='ver_Shamim';
...
for m=1:numel(monkeys)
    ...
    for s=1:numel(sessions{m})
        ...
        ecg_bna_cfg.session_info(cumulative_sessions) = ...
            ...
            'Date',           date, ...
            'Input_ECG',         [ecg_preprocess_folder filesep monkey filesep date filesep date '_cap.mat'], ...
