%% Initialization
%%ECG_Magnus_TaskRest_generalTrig_test.m
...
cfg.spk.jitter_method='interval shuffling'; % 'train_jitter';'interval_jitter';'trigger_jitter'
...
sessions{1}=sort([20230519]);  %20230106, 
