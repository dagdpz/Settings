...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'Y:\Projects\Pulv_eye_hand\behavior\Thesis\20161210\Linus_Flaffus_ephys_inter_only';
...
steady.passfilter                   =   {'saccades','lat',0.08, 0.5;'reaches','lat',0.2, 10;}; % as in thesis table
