...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Retreat\20160812\inactivation_6_inactivation_instructed';
...
subject_ID{1}='Control';
group{1}                        = {'Linus_ina',     'Linus_ina',    'Linus_ina',    'Linus_ina',     'Linus_ina',   'Linus_ina'};
dates_subject_in{1}             = {20160610;        20160615;       20160624;       20160701;         20160708;      20160805};
batching{1}.runs                = {[4 5];           2;              2;              [1, 2];           [1 2 3];       [1 2]}; % 1 run by run, 2 session by session, 3 group by group
batching_type{1}                = 3;
