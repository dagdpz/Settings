...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Retreat\20160812\Fixed_vs_randomized_instructed';
...
group{2}                        = {'Linus',         'Linus',        'Linus',            'Linus'             'Linus'};
dates_subject_in{2}             = {20160720;        20160722;       20160726;           20160727;           20160728};
batching{2}.runs                = {4;               3;              1;                  1;                  1};  % either empty or specific runs specified
