%% Linus DAG evaluation + new rand dataset
...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Linus\bars_C_plus_new_rand_IN';
...
% FIXED VS RANDOMIZED CONTROLS STARTS
subject_ID{1}='Control';
group{1}                        = {'Linus',     'Linus',    'Linus',    'Linus',            'Linus',   'Linus',    'Linus',       'Linus',        'Linus',      	'Linus'};
dates_subject_in{1}             = {20160609;    20160616;   20160617;    20160622;          20160623;   20160630;   20160707;      20160712;       20160713;        20160714};
batching{1}.runs                = {2;           1;          1;           [1 2];             1;          1;          4;             1;              1;               3};  % either empty or specific runs specified
...
dates_subject_in{2}             = {20160720;        20160722;       20160726;           20160727;           20160728;       20160804 };
batching{2}.runs                = {4;               3;              1;                  1;                  1;              1};  % either empty or specific runs specified
batching_type{2}                = 3; % 1 run by run, 2 session by session, 3 group by group
batching{2}.range_of_dates      = 0;
% FIXED VS RANDOMIZED CONTROLS ENDS
