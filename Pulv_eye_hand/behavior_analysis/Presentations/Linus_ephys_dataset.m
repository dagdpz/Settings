...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Retreat\20160812\Linus_ephys';
...
group{1}                        = {'Linus_phys'};
dates_subject_in{1}                = {[20160203 20160506]};
...
group{2}                        = {'Linus_phys'};
dates_subject_in{2}                = {[20160203 20160506]};
