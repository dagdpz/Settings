...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Retreat\20160812\DAG_evaluation';
...
group{1}                        = {'Linus',     'Linus',    'Linus',    'Linus',        'Linus',     'Linus',    'Linus_ina',    'Linus_ina',    'Linus_ina'};
dates_subject_in{1}             = {20160607;    20160616;   20160617;    20160622;      20160623;    20160630;   20160610;       20160615;       20160624};
batching{1}.runs                = {2;           1;          1;           [1 2];         1;           1;          3;              1;              1};  % either empty or specific runs specified
batching_type{1}                = 3; % 1 run by run, 2 session by session, 3 group by group
batching{1}.range_of_dates      = 0;

subject_ID{2}='Experimental';
group{2}                        = {'Linus_ina',     'Linus_ina',    'Linus_ina',    'Linus_ina',      'Linus_ina'};
dates_subject_in{2}             = {20160610;        20160615;       20160624;       20160701;         20160708};
batching{2}.runs                = {[4 5];           2;              2;              [1, 2];           [1 2 3]};  % either empty or specific runs specified
