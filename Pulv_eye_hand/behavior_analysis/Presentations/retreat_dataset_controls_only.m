...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Retreat\20160812\inactivation_6_controls_instructed';
...
group{2}                        = {'Linus_ina',     'Linus_ina',    'Linus_ina',    'Linus',        'Linus',        'Linus'};
dates_subject_in{2}             = {20160610;        20160615;       20160624;       20160630;       20160707;       20160804};
batching{2}.runs                = {3;               1;              1;              1;              4;              1}; % 1 run by run, 2 session by session, 3 group by group
batching_type{2}                = 3;
