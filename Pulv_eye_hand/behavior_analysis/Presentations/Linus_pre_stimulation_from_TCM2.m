%% Linus TCM2 [20131017 20140526] datasets
...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Linus_pre_craniotomy_from_TCM2';
GLO.type_of_free_gaze               =   '1';
GLO.one_subject                     =   1;
...
% % LINUS TCM2 DATASET STARTS pre penetration
% subject_ID{1}='Control';
% group{1}                        = {'Linus'};
% dates_subject_in{1}                = {[20131017 20131206]};
...
% group{2}                        = {'Linus'};
% dates_subject_in{2}                = {[20131017 20131206]};
...
% %% LINUS TCM2 DATASET ENDS pre penetration


% LINUS TCM2 DATASET STARTS pre craniotomy
subject_ID{1}='Control';
group{1}                        = {'Linus'};
dates_subject_in{1}                = {[20131017 20131106]};
batching_type{1}                = 2; % 1 run by run, 2 session by session, 3 group by group
batching{1}.range_of_dates      = 1;
batching{1}.runs                = {};  % either empty or specific runs specified
...
subject_ID{2}='Experimental';
group{2}                        = {'Linus'};
dates_subject_in{2}                = {[20131017 20131106]};
batching_type{2}                = 2; % 1 run by run, 2 session by session, 3 group by group
batching{2}.range_of_dates      = 1;
batching{2}.runs                = {};  % either empty or specific runs specified
%% LINUS TCM2 DATASET ENDS pre craniotomy


% % LINUS TCM2 - cranio DATASET STARTS
% subject_ID{1}='Control';
% group{1}                        = {'Linus'};
% dates_subject_in{1}                = {[20131017 20131112]};
