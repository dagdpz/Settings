%% Flaffus control direct for ina [20160701 20160719] datasets
...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\Flaffus_direct_controls_for_ina';
...
group{1}                        = {'Flaffus'};
dates_subject_in{1}                = {[20160701 20160719]};
...
group{2}                        = {'Flaffus'};
dates_subject_in{2}                = {[20160701 20160719]};
