%% Flaffus Flaffus control direct inactivation 
...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\2017\Flaffus_February';
...
subject_ID{1}='Control';
group{1}                        = {'Flaffus'};
dates_subject_in{1}             = {[20170221 20170224]};
batching_type{1}                = 2; % 1 run by run, 2 session by session, 3 group by group
batching{1}.range_of_dates      = 1;
batching{1}.runs                = {};
