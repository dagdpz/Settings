...
GLO.append_pdfs                     =   0;
GLO.parent_folder                   =   '';
GLO.folder_to_save                  =   'K:\Projects\Pulv_eye_hand\behavior\2017\Flaffus_20170412_01_vs_Fla_ina_20170412_02';
...
subject_ID{1}='Control';
group{1}                        = {'Flaffus'};
dates_subject_in{1}             = {[20170412 20170412]};
batching{1}.runs                = {1}; % 1 run by run, 2 session by session, 3 group by group
batching_type{1}                = 3;
...
group{2}                        = {'Flaffus_ina'};
dates_subject_in{2}             = {[20170412 20170412]};
batching{2}.runs                = {2};  % either empty or specific runs specified % either empty or specific runs specified
