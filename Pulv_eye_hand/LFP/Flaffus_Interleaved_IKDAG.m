...
lfp_tfa_cfg.results_folder = 'E:\Projects\Pulv_eye_hand\LFP';
...
lfp_tfa_cfg.version = 'Flaffus_Interleaved';
...
if ~lfp_tfa_cfg.process_LFP
    lfp_tfa_cfg.proc_lfp_folder = ...
        'E:\Projects\Pulv_eye_hand\LFP\Flaffus_Interleaved\Processed LFP';
end
...
if ~lfp_tfa_cfg.compute_site_average
    lfp_tfa_cfg.analyse_lfp_folder = ...
        'E:\Projects\Pulv_eye_hand\LFP\Flaffus_Interleaved\LFP Analysis';
end
...
lfp_tfa_cfg.analyses = {'sync'}; % {'tfs', 'evoked'} 
...
if any(strcmp(lfp_tfa_cfg.analyses, 'sync') | strcmp(lfp_tfa_cfg.analyses, 'syncsp'))
    % lfp_tfa_cfg.compare.target_pairs = {{'MIP_R', 'MIP_R'}, {'MIP_R', 'MIP_L'}, {'MIP_L', 'MIP_L'}}; 
    lfp_tfa_cfg.compare.target_pairs = {{'dPulv_l', 'dPulv_l'}};
end
